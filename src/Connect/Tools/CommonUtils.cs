...
//    /// <summary>
//    /// 判断参数字符串是否以"http://localhost"或"http://127.0.0.1"开始。
//    /// </summary>
//    /// <param name="hostUrl"></param>
//    /// <returns></returns>
//    public static bool? IsLocalHost( string hostUrl ) {
//      if ( string.IsNullOrWhiteSpace( hostUrl ) )
//        return null;
//      return hostUrl.StartsWith( "http://localhost" ) || hostUrl.StartsWith( "http://127.0.0.1" );
//    }
